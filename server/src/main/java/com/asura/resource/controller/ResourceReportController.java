...
public class ResourceReportController {
    ...
    @ResponseBody
    public String groupData(String entName, String inventoryId) {
        SearchMap searchMap = new SearchMap();
        if (CheckUtil.checkString(entName)) {
            searchMap.put("entName", entName);
        }
        serverController.getGrsoupsId(inventoryId, searchMap);
    ...
    @ResponseBody
    public String entnameData(String groupsName, String inventoryId) {
        SearchMap searchMap = new SearchMap();
    ...
    @ResponseBody
    public String reportServiceName(String groupsName, String inventoryId) {
        SearchMap searchMap = new SearchMap();
        if (CheckUtil.checkString(groupsName)) {
            searchMap.put("groupsName", groupsName);
        }
    ...
    @ResponseBody
    public String typeData(String groups, String inventoryId) {
        SearchMap map = new SearchMap();
        if (CheckUtil.checkString(groups)) {
            map.put("groupsName", groups);
        }
        serverController.getGrsoupsId(inventoryId, map);
    ...
    @ResponseBody
    public String createData(String inventoryId) throws Exception {
        SearchMap searchMap = new SearchMap();
    ...
    @ResponseBody
    public String selectUserCount(String groupsName, String entName, String inventoryId) {
        SearchMap searchMap = new SearchMap();
