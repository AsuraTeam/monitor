 ...
 * @since 1.0
 */
@Repository("com.asura.monitor.configure.dao.MonitorTiggerDao")
public class MonitorTiggerDao extends BaseDao<MonitorTiggerEntity>{
     ...
     */
     public PagingResult<MonitorTiggerEntity> findAll(SearchMap searchMap, PageBounds pageBounds, String sqlId){
        return mybatisDaoContext.findForPage(this.getClass().getName()+"."+sqlId,MonitorTiggerEntity.class,searchMap,pageBounds);
     }
}